...
imageDesc: "Diagram 3 lingkaran Internet-Intranet-Extranet dengan contoh aplikasi di masing-masing",
...
imageDesc: "Diagram Intranet dengan panah keluar ke Supplier, Driver, Seller melalui VPN/firewall",
...
imageDesc: "Split screen 5 aplikasi: pabrik, Shopee, Gojek, rumah sakit, EDC + diagram Venn summary",
...
imageDesc: "Piramida terbalik: Tier 1 atas, Tier 2 tengah, Tier 3 bawah, end users paling bawah",
...
imageDesc: "Gedung kantor dengan network internal antar departemen + firewall di luar",
...
imageDesc: "Diagram 3 layer: Core server, Distribution switches, Access workstations",
...
imageDesc: "Decision tree dari 'Siapa yang perlu akses?' ke 3 pilihan dengan use case",
...
imageDesc: "Split diagram keuntungan (ikon positif) vs tantangan (ikon warning)",
...
imageDesc: "Split diagram dengan ikon shield (keuntungan) vs cost/barrier (tantangan)",
